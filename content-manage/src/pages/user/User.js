...
import {Card,Button,Modal,Input,Form,DatePicker,Radio,Select} from 'antd'
...
class User extends Component {
    ...
    requestList = ()=>{
        Axios.requestList(this.params,'/user/list',this,true);
    }
    // 操作员工
    handleOperator = (type)=>{
    ...
    render() {
        ...
        return (
            <div>
                <Card>
                    <BaseFormItem formList={this.FormList} handleBaseToOrder={this.handleUserSubmit}/>
                </Card>
                <Card>
